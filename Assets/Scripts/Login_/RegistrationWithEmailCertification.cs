...
public class RegistrationWithEmailCertification : MonoBehaviour
{
    ...
    {
        string url = "http://14.45.49.223:4000/api/v1/auth/emailCertification";
    ...
    public void RegisterUser()
    {
        ...
        if (emailfilled || userIdfilled || passwordfilled || nicknamefilled || codefilled)
        {
            ...
            Vector2 customposition = new Vector2(0, -525);
            StartCoroutine(ShowErrorMessage("모든 입력란을 채워주세요.", customposition));
            return;
        }

        string url = "http://14.45.49.223:4000/api/v1/auth/signUp";
