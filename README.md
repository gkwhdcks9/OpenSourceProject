...
### 10월  
- **10/26** 아이디어 결정 회의 → '법무사 챗봇' 결정[김원호, 박선화, 최승민, 하종찬] 
- **10/27** Unity AI 씬 디자인 시작[하종찬]
- **10/28** 데이터 분석 시작[박선화]  
- **10/31** Unity AI 씬 디자인 에셋 적용 (Top-Down 2D RPG Assets Pack)[하종찬]
...
- **11/08** Home 씬 디자인 시작 (Modern exteriors - RPG Tileset), 회원가입/로그인 시작[최승민]
- **11/10**
  - Unity AI 씬 말풍선 크기 조정 문의[하종찬]
  - Spring 통신 개발 완료[김원호]  
- **11/14** 주요 논제 토의[김원호, 박선화, 최승민, 하종찬]
